...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errors === []) {
        $idLivre = Livre::creer($donnees);
        if ($idLivre > 0) {
            $_SESSION['flash_message'] = 'Le livre a bien été ajouté à la collection.';
            header('Location: dashboard.php', true, 302);
            exit;
        }

        $errors['global'] = 'Impossible d\'enregistrer le livre pour le moment.';
    }
}
?>
<!DOCTYPE html>
...
<title>Ajouter un livre — Admin LECTORIA</title>
...
<div class="admin-shell">
  <aside class="sidebar">
    ...
    <nav class="side-nav">
      ...
      <a href="add_livre.php" class="active">
  ...
  <main class="main">
    <p class="breadcrumb"><a href="dashboard.php">Catalogue</a> / Ajouter un livre</p>
    <div class="main-header">
      <h1>Ajouter un nouveau livre</h1>
      <p>Renseignez les informations pour publier un ouvrage dans la collection</p>
    </div>
    ...
    <?php
        $submitLabel = 'Publier le livre dans la collection';
